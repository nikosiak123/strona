# -*- coding: utf-8 -*-
# Wersja: OSTATECZNA (Vertex AI + Czas Systemowy + Wzmocniona Analiza AI)
...
FOLLOW_UP_WINDOW_HOURS = 23 # Maksymalny czas w godzinach, na który ustawiamy przypomnienie (nieco poniżej 24h)
